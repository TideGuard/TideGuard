...
`/health`, `/wait`, `/join`, `/status`, `/leave`, `/heartbeat`, `/enter`, `/admit`, `/mode`, `/pause`, `/metrics`, `/admin`, `/api/admin/*`, `/api/demo/*`, `/cost`, `/api/cost-estimate`, `/demo`, `/demo/live`, `/demo/live/protected`, `/openapi.yaml`, `/openapi.json`
